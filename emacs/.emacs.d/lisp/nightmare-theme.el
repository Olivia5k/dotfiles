...
(autothemer-deftheme
 ...
 ((default                                   (:foreground nightmare-light0 :background nightmare-dark0))
  ...
  (markdown-header-face                      (:inherit font-lock-function-name-face :bold t :height 2.5 :family "Yanone Kaffeesatz"))
  (markdown-header-face-2                    (:inherit font-lock-builtin-face :bold t :height 2.0 :family "Yanone Kaffeesatz"))
  (markdown-header-face-3                    (:inherit font-lock-string-face :bold t :height 1.7 :family "Yanone Kaffeesatz"))
  (markdown-header-face-4                    (:inherit font-lock-variable-name-face :bold t :height 1.5 :family "Yanone Kaffeesatz"))
