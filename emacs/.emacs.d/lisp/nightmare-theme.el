...
(autothemer-deftheme
 ...
 ((default                                   (:foreground nightmare-light0 :background nightmare-dark0))
  ...
  (org-level-6                               (:foreground nightmare-neutral_green :bold t))
  (org-level-7                               (:foreground nightmare-neutral_red :bold t))
  (org-level-8                               (:foreground nightmare-neutral_blue :bold t))
  ...
  (magit-diff-file-heading                   (:background nightmare-dark0_hard))
  (magit-diff-hunk-heading                   (:background nightmare-dark0_soft :foreground nightmare-light3))
  (magit-diff-file-heading-highlight         (:background nightmare-dark1 :bold t))
  (magit-diff-hunk-heading-highlight         (:background nightmare-dark1 ))
