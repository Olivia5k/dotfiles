...
if &t_Co > 255
   ...
   hi StatusLineNC    ctermfg=234 ctermbg=58
   ...
   hi TabLine         ctermfg=100 ctermbg=235   cterm=none
   hi TabLineFill     ctermfg=233 ctermbg=235   cterm=none
   hi TabLineSel      ctermfg=136 ctermbg=233   cterm=bold
end
