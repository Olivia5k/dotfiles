...
(autothemer-deftheme
 ...
 ((default                                   (:foreground nightmare-light0 :background nightmare-dark0))
  ...
  (org-agenda-date-today                     (:foreground nightmare-light2 :slant 'italic :weight 'bold))
  ...
  (org-date                                  (:foreground nightmare-faded_aqua :underline t))
  (org-deadline-announce                     (:foreground nightmare-faded_red))
  ...
  (org-level-1                               (:foreground nightmare-bright_orange :bold t))
  (org-level-2                               (:foreground nightmare-bright_green :bold t))
  (org-level-3                               (:foreground nightmare-bright_blue :bold t))
  (org-level-4                               (:foreground nightmare-bright_yellow :bold t))
  ...
  (org-link                                  (:foreground nightmare-bright_yellow :underline t))
  (org-scheduled                             (:foreground nightmare-bright_green))
  (org-scheduled-previously                  (:foreground nightmare-bright_red))
  (org-scheduled-today                       (:foreground nightmare-bright_blue))
  ...
  (org-todo                                  (:foreground nightmare-bright_red :weight 'bold :bold t))
  ...
  (org-mode-line-clock                       (:foreground nightmare-light2 :background nightmare-dark0))
  ...
  (magit-blame-heading                       (:background nightmare-dark1 :foreground nightmare-light0))
