...
(let* ((class '((class color) (min-colors 89)))
      (g (display-graphic-p))
      (ujelly-fg              (if g "#ffffff" "color-255"))
      (ujelly-bg              (if g "#111111" nil))
      (ujelly-blue-0          (if g "#8fbfdc" "color-110"))
      (ujelly-blue-1          (if g "#97aad3" "color-74"))
      (ujelly-blue-2          (if g "#97aad3" "color-123"))
      (ujelly-green-0         (if g "#99ad6a" "color-107"))
      (ujelly-green-1         (if g "#447799" "color-66"))
      (ujelly-green-2         (if g "#a8ff60" "color-155"))
      (ujelly-green-3         (if g "#a8ff60" "color-108"))
      (ujelly-grey-0          (if g "#888888" "color-96"))
      (ujelly-grey-1          (if g "#7f7f7f" "color-240"))
      (ujelly-grey-2          (if g "#151515" "color-237"))
      (ujelly-grey-3          (if g "#1c1c1c" "color-235"))
      (ujelly-grey-4          (if g "#222222" "color-236"))
      (ujelly-orange-0        (if g "#ffb964" "color-209"))
      (ujelly-purple-0        (if g "#8197bf" "color-103"))
      (ujelly-purple-1        (if g "#474e90" "color-60"))
      (ujelly-purple-2        (if g "#cd00cd" "color-97"))
      (ujelly-purple-3        (if g "#540063" "color-53"))
      (ujelly-purple-4        (if g "#a40073" "color-125"))
      (ujelly-purple-5        (if g "#a40073" "color-138"))
      (ujelly-purple-6        (if g "#a40073" "color-177"))
      (ujelly-red-0           (if g "#97aad2" "color-197"))
      (ujelly-red-1           (if g "#dd0093" "color-162"))
      (ujelly-red-2           (if g "#de5577" "color-168"))
      (ujelly-red-3           (if g "#ff73fd" "color-207"))
      (ujelly-red-4           (if g "#ff73fd" "color-196"))
      (ujelly-yellow-0        (if g "#fad07a" "color-222"))
      (ujelly-yellow-1        (if g "#ffff00" "color-179"))
      (ujelly-delimiter-1     (if g "#8090a0" "color-103"))
      (ujelly-delimiter-2     (if g "#90a080" "color-108"))
      (ujelly-delimiter-3     (if g "#a08090" "color-138"))
      (ujelly-delimiter-4     (if g "#9080a0" "color-101"))
      (ujelly-delimiter-5     (if g "#8090a0" "color-110"))
      (ujelly-delimiter-6     (if g "#90a080" "color-182"))
      (ujelly-delimiter-7     (if g "#a08090" "color-104"))
      (ujelly-delimiter-8     (if g "#9080a0" "color-177"))
      (ujelly-delimiter-9     (if g "#9080a0" "color-65"))
      (ujelly-delimiter-10    (if g "#9080a0" "color-139"))
      (ujelly-delimiter-11    (if g "#9080a0" "color-144"))
      (ujelly-delimiter-12    (if g "#9080a0" "color-38"))
      (ujelly-delimiter-13    (if g "#9080a0" "color-188"))
      (ujelly-delimiter-14    (if g "#9080a0" "color-117"))
      (ujelly-delimiter-15    (if g "#9080a0" "color-111"))

      ;; darktooth translations
      (ujelly-dark0_hard      (if g "#1D2021" "color-234"))
      (ujelly-dark0           (if g "#282828" "color-235"))
      (ujelly-dark0_soft      (if g "#32302F" "color-236"))
      (ujelly-dark1           (if g "#3C3836" "color-237"))
      (ujelly-dark2           (if g "#504945" "color-239"))
      (ujelly-dark3           (if g "#665C54" "color-241"))
      (ujelly-dark4           (if g "#7C6F64" "color-243"))

      (ujelly-medium          (if g "#928374" "color-245")) ;; or 244

      (ujelly-light0_hard     (if g "#FFFFC8" "color-230"))
      (ujelly-light0          (if g "#FDF4C1" "color-229"))
      (ujelly-light0_soft     (if g "#F4E8BA" "color-228"))
      (ujelly-light1          (if g "#EBDBB2" "color-223"))
      (ujelly-light2          (if g "#D5C4A1" "color-250"))
      (ujelly-light3          (if g "#BDAE93" "color-248"))
      (ujelly-light4          (if g "#A89984" "color-246"))

      (ujelly-bright_red      ujelly-red-0)
      (ujelly-bright_green    ujelly-green-2)
      (ujelly-bright_yellow   (if g "#FABD2F" "color-214"))
      (ujelly-bright_blue     (if g "#83A598" "color-109"))
      (ujelly-bright_purple   (if g "#D3869B" "color-175"))
      (ujelly-bright_aqua     (if g "#8EC07C" "color-108"))
      (ujelly-bright_orange   (if g "#FE8019" "color-208"))

      ;; neutral, no 256-color code, requested, nice work-around meanwhile
      (ujelly-neutral_red     (if g "#FB4934" "#D75F5F"))
      (ujelly-neutral_green   (if g "#B8BB26" "#AFAF00"))
      (ujelly-neutral_yellow  (if g "#FABD2F" "#FFAF00"))
      (ujelly-neutral_blue    (if g "#83A598" "#87AFAF"))
      (ujelly-neutral_purple  (if g "#D3869B" "#D787AF"))
      (ujelly-neutral_aqua    (if g "#8EC07C" "#87AF87"))
      (ujelly-neutral_orange  (if g "#FE8019" "#FF8700"))

      (ujelly-faded_red       (if g "#9D0006" "color-88"))
      (ujelly-faded_green     (if g "#79740E" "color-100"))
      (ujelly-faded_yellow    (if g "#B57614" "color-136"))
      (ujelly-faded_blue      (if g "#076678" "color-24"))
      (ujelly-faded_purple    (if g "#8F3F71" "color-96"))
      (ujelly-faded_aqua      (if g "#427B58" "color-66"))
      (ujelly-faded_orange    (if g "#AF3A03" "color-130"))

      (ujelly-dark_red        (if g  "#421E1E" "color-52"))
      (ujelly-dark_green      (if g  "#2B280F" "color-22"))
      (ujelly-dark_yellow     (if g  "#4D3B27" "color-3"))
      (ujelly-dark_blue       (if g  "#2B3C44" "color-4"))
      (ujelly-dark_purple     (if g  "#4E3D45" "color-57"))
      (ujelly-dark_aqua       (if g  "#36473A" "color-23"))
      (ujelly-dark_orange     (if g  "#613620" "color-130"))

      (ujelly-delimiter-one   (if g "#5C7E81" "color-66"))
      (ujelly-delimiter-two   (if g "#837486" "color-102"))
      (ujelly-delimiter-three (if g "#9C6F68" "color-94"))
      (ujelly-delimiter-four  (if g "#7B665C" "color-137"))

      (ujelly-white           (if g "#FFFFFF" "white"))
      (ujelly-black           (if g "#000000" "black"))
      (ujelly-sienna          (if g "#DD6F48" "sienna"))
      (ujelly-darkslategray4  (if g "#528B8B" "DarkSlateGray4"))
      (ujelly-lightblue4      (if g "#66999D" "LightBlue4"))
      (ujelly-burlywood4      (if g "#BBAA97" "burlywood4"))
      (ujelly-aquamarine4     (if g "#83A598" "aquamarine4"))
      (ujelly-turquoise4      (if g "#61ACBB" "turquoise4")))

      (custom-theme-set-faces
       'ujelly
       ;; Defaults
       `(default                             ((t (:foreground ,ujelly-fg :background ,ujelly-bg))))
       `(font-lock-builtin-face              ((t (:foreground ,ujelly-red-3 :bold t))))
       `(font-lock-comment-face              ((t (:foreground ,ujelly-grey-0))))
       `(font-lock-constant-face             ((t (:foreground ,ujelly-red-2 :bold t))))
       `(font-lock-doc-face                  ((t (:foreground ,ujelly-green-0))))
       `(font-lock-function-name-face        ((t (:foreground ,ujelly-purple-6 :bold t))))
       `(font-lock-keyword-face              ((t (:foreground ,ujelly-purple-2 :bold t))))
       `(font-lock-preprocessor-face         ((t (:foreground ,ujelly-fg))))
       `(font-lock-string-face               ((t (:foreground ,ujelly-purple-5))))
       `(font-lock-type-face                 ((t (:foreground ,ujelly-red-1 :bold t))))
       `(font-lock-variable-name-face        ((t (:foreground ,ujelly-red-1 :bold t))))
       ...
       ;; JS2-mode
       `(js2-function-param                  ((t (:foreground ,ujelly-red-3))))
