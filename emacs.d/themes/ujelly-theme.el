...
(let ((class '((class color) (min-colors 89)))
      (ujelly-fg "#ffffff")
      (ujelly-bg "#111117")
      (ujelly-delimiter-one "#8090a0")
      (ujelly-delimiter-two "#90a080")
      (ujelly-delimiter-three "#a08090")
      (ujelly-delimiter-four "#9080a0")
      (ujelly-blue-0 "#8fbfdc")
      (ujelly-blue-1 "#97aad3")
      ...
      (custom-theme-set-faces
       ...
       `(font-lock-builtin-face ((,class (:foreground ,ujelly-orange-0 :bold t))))
       `(font-lock-comment-face ((,class (:bold t :foreground ,ujelly-grey-0))))
       `(font-lock-constant-face ((,class (:foreground ,ujelly-green-1 :bold t))))
       `(font-lock-doc-face ((,class (:foreground ,ujelly-green-0))))
       `(font-lock-function-name-face ((,class (:foreground ,ujelly-yellow-0 :bold t))))
       `(font-lock-keyword-face ((,class (:foreground ,ujelly-purple-0 :bold t))))
       `(font-lock-preprocessor-face ((,class (:foreground ,ujelly-fg))))
       `(font-lock-string-face ((,class (:foreground ,ujelly-green-0 :bold t))))
       `(font-lock-type-face ((,class (:foreground ,ujelly-orange-0 :bold t))))
       `(font-lock-variable-name-face ((,class (:foreground ,ujelly-blue-1 :bold t))))
       ...
       `(fringe ((,class (:foreground ,ujelly-grey-1 :background ,ujelly-grey-4))))
       ...
       ;; RainbowDelimiters
       `(rainbow-delimiters-depth-1-face           ((,class (:foreground ,ujelly-delimiter-one ))))
       `(rainbow-delimiters-depth-2-face           ((,class (:foreground ,ujelly-delimiter-two ))))
       `(rainbow-delimiters-depth-3-face           ((,class (:foreground ,ujelly-delimiter-three ))))
       `(rainbow-delimiters-depth-4-face           ((,class (:foreground ,ujelly-delimiter-four ))))
       `(rainbow-delimiters-depth-5-face           ((,class (:foreground ,ujelly-delimiter-one ))))
       `(rainbow-delimiters-depth-6-face           ((,class (:foreground ,ujelly-delimiter-two ))))
       `(rainbow-delimiters-depth-7-face           ((,class (:foreground ,ujelly-delimiter-three ))))
       `(rainbow-delimiters-depth-8-face           ((,class (:foreground ,ujelly-delimiter-four ))))
       `(rainbow-delimiters-depth-9-face           ((,class (:foreground ,ujelly-delimiter-one ))))
       `(rainbow-delimiters-depth-10-face          ((,class (:foreground ,ujelly-delimiter-two ))))
       `(rainbow-delimiters-depth-11-face          ((,class (:foreground ,ujelly-delimiter-three ))))
       `(rainbow-delimiters-depth-12-face          ((,class (:foreground ,ujelly-delimiter-four ))))

       ;; RainbowIdentifiers
       `(rainbow-identifiers-identifier-1          ((,class (:foreground ,ujelly-delimiter-one ))))
       `(rainbow-identifiers-identifier-2          ((,class (:foreground ,ujelly-delimiter-two ))))
       `(rainbow-identifiers-identifier-3          ((,class (:foreground ,ujelly-delimiter-three ))))
       `(rainbow-identifiers-identifier-4          ((,class (:foreground ,ujelly-delimiter-four ))))
       `(rainbow-identifiers-identifier-5          ((,class (:foreground ,ujelly-delimiter-one ))))
       `(rainbow-identifiers-identifier-6          ((,class (:foreground ,ujelly-delimiter-two ))))
       `(rainbow-identifiers-identifier-7          ((,class (:foreground ,ujelly-delimiter-three ))))
       `(rainbow-identifiers-identifier-8          ((,class (:foreground ,ujelly-delimiter-four ))))
       `(rainbow-identifiers-identifier-9          ((,class (:foreground ,ujelly-delimiter-one ))))
       `(rainbow-identifiers-identifier-10         ((,class (:foreground ,ujelly-delimiter-two ))))
       `(rainbow-identifiers-identifier-11         ((,class (:foreground ,ujelly-delimiter-three ))))
       `(rainbow-identifiers-identifier-12         ((,class (:foreground ,ujelly-delimiter-four ))))
       `(rainbow-identifiers-identifier-13         ((,class (:foreground ,ujelly-delimiter-one ))))
       `(rainbow-identifiers-identifier-14         ((,class (:foreground ,ujelly-delimiter-two ))))
       `(rainbow-identifiers-identifier-15         ((,class (:foreground ,ujelly-delimiter-three ))))
