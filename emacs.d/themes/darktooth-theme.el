...
(let (
  ...
  (custom-theme-set-faces
   ...
   `(magit-diff-added                   ((t (:foreground ,darktooth-bright_green))))
   `(magit-diff-added-highlight         ((t (:foreground ,darktooth-bright_green :background ,darktooth-dark0_hard))))
   `(magit-diff-base                    ((t (:foreground ,darktooth-dark0))))
   `(magit-diff-base-highlight          ((t (:foreground ,darktooth-dark0 :background ,darktooth-dark0_hard))))
   `(magit-diff-conflict-heading        ((t (:foreground ,darktooth-faded_red))))
   `(magit-diff-context                 ((t (:foreground ,darktooth-dark3))))
   `(magit-diff-context-highlight       ((t (:foreground ,darktooth-dark3 :background ,darktooth-dark0_hard))))
   `(magit-diff-file-heading            ((t (:foreground ,darktooth-light0))))
   `(magit-diff-file-heading-highlight  ((t (:foreground ,darktooth-light0 :background ,darktooth-dark0_hard :weight bold))))
   `(magit-diff-file-heading-selection  ((t (:foreground ,darktooth-light0))))
   `(magit-diff-hunk-heading            ((t (:foreground ,darktooth-light3 :background ,darktooth-dark0_soft))))
   `(magit-diff-hunk-heading-highlight  ((t (:foreground ,darktooth-light2 :background ,darktooth-dark1))))
   ...
   `(magit-diff-removed                 ((t (:foreground ,darktooth-bright_red))))
   `(magit-diff-removed-highlight       ((t (:foreground ,darktooth-bright_red  :background ,darktooth-dark0_hard))))
   ...
   `(magit-section-highlight            ((t (:background ,darktooth-dark0_hard :weight bold))))
