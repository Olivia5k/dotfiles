...
** eclim
   ...
   The java integration into emacs!
...
*** Functions
    ...
    #+begin_src emacs-lisp
      ...
      Ignores buffers that are not visiting files.
   ...
   #+begin_src emacs-lisp
     ...
     directory to make multiple eshell windows easier."
       ...
       (let* ((parent (if (buffer-file-name)
         ...
         (if (get-buffer shellname)
             ;; If we're already in eshell, go back.
